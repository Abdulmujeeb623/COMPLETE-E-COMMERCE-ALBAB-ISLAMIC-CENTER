...
// SQL query to fetch transaction, transaction details, and billing information
$query = "SELECT t.transaction_id, t.transaction_reference, t.timestamp, t.email, t.total_amount, t.payment_status,
                 b.number, b.address1, b.name, b.address2, b.city, b.country, b.state,
          ...
          ORDER BY t.timestamp DESC"; // Order by timestamp dascending

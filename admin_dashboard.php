            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        ...
                        <a href="" class="nav-item nav-link">Prophetic Medicine</a>
                        <a href="" class="nav-item nav-link">Bathing Soaps</a>
                        <a href="" class="nav-item nav-link">Quran</a>
                        <a href="" class="nav-item nav-link">Hadith</a>
                        <a href="" class="nav-item nav-link">Tafsir</a>
                        <a href="" class="nav-item nav-link">Praying Materials</a>
                        <a href="" class="nav-item nav-link">Islamic CDS</a>
                        <a href="" class="nav-item nav-link">Perfumes</a>
                        <a href="" class="nav-item nav-link">Snacks and drinks</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
